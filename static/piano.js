...
function ttt2(paeCode, clef, width, scalePercent){
...
function htmlForKeyboardWithOctaves(numberOfOctaves, startOctave, showLabels, withShiftButtons, withNoteSelection, withClefSelection) {
    ...
    for (var i = 0; i < _displayedOctaves; i++) {
        if (showLabels) {
            keyhoardHTML += '<li id="c1" class="whiteKey"><p>C' + (currentOctave + 1) + '</p></li>'
            keyhoardHTML += '<li class="blackKeySharp"><p>♯</p></li>'
            keyhoardHTML += '<li class="blackKeyFlat"><p>♭</p></li>'
        } else {
            keyhoardHTML += '<li id="c1" class="whiteKey"></li>'
            keyhoardHTML += '<li class="blackKeySharp"></li>'
           keyhoardHTML += ' <li class="blackKeyFlat"></li>'
        }

        keyhoardHTML += '<li id="c2" class="whiteKey"></li>'
        keyhoardHTML += '<li class="blackKeySharp"></li>'    
        keyhoardHTML += '<li class="blackKeyFlat"></li>'
        keyhoardHTML += '<li id="c3" class="whiteKey"></li>'
        keyhoardHTML += '<li id="c4" class="whiteKey"></li>'
        keyhoardHTML += '<li class="blackKeySharp"></li>'
        keyhoardHTML += '<li class="blackKeyFlat"></li>'
        keyhoardHTML += '<li id="c5" class="whiteKey"></li>'
        keyhoardHTML += '<li class="blackKeySharp"></li>'
        keyhoardHTML += '<li class="blackKeyFlat"></li>'
        keyhoardHTML += '<li id="c6" class="whiteKey"></li>'
        keyhoardHTML += '<li class="blackKeySharp"></li>'
        keyhoardHTML += '<li class="blackKeyFlat"></li>'
        keyhoardHTML += '<li id="c7" class="whiteKey"></li>'
        currentOctave++
    }
    keyhoardHTML += '\
        </ul>\n'
